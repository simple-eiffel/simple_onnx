...
extern EIF_TYPED_VALUE F438_3241(EIF_REFERENCE);
...
EIF_TYPED_VALUE F438_3241 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 437, Current, 0, 0, 3283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(437, Current, 3283);
	RTIV(Current, RTAL);
