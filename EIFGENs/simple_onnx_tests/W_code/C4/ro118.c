...
extern EIF_TYPED_VALUE F118_1553(EIF_REFERENCE);
extern EIF_TYPED_VALUE F118_1554(EIF_REFERENCE);
extern EIF_TYPED_VALUE F118_1555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F118_1556(EIF_REFERENCE);
extern void F118_1557(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F118_1558(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F118_1555 (EIF_REFERENCE Current)
{
	GTCX
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1525, 138))(Current)).it_i4);
...
/* {ROUTINE_FAILURE}.tag */
RTOID (F118_1556)
EIF_TYPED_VALUE F118_1556 (EIF_REFERENCE Current)
{
	GTCX
...
void F118_1557 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 117, Current, 0, 1, 1579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(117, Current, 1579);
	RTCC(arg1, 117, l_feature_name, 1, RTWCT(1433, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1433, 0xF800010A, 0); /* routine_name */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F118_1558 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 117, Current, 0, 1, 1580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(117, Current, 1580);
	RTCC(arg1, 117, l_feature_name, 1, RTWCT(1434, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1434, 0xF800010A, 0); /* class_name */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1434, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
