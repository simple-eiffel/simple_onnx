...
extern void F88_1377(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1378(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F88_1379(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1380(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1381(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F88_1383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1384(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1385(EIF_REFERENCE);
...
extern void F88_1389(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F88_1390(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F88_1391(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F88_1392(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F88_1397(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1398(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1399(EIF_REFERENCE);
...
void F88_1377 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1406);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1406);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F88_1378 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 87, Current, 0, 1, 1407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1407);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1286, dtype))(Current, ui4_1x)).it_b);
...
EIF_TYPED_VALUE F88_1379 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1408);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F88_1380 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1409);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1409);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
EIF_TYPED_VALUE F88_1381 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1410);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1410);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F88_1382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 87, Current, 4, 1, 1411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1411);
	RTCC(arg1, 87, l_feature_name, 1, eif_new_type(266, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F88_1383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1412);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype));
...
EIF_TYPED_VALUE F88_1384 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1413);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F88_1385 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1414);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1414);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype));
...
EIF_TYPED_VALUE F88_1387 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1416);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (tb1) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 1324, 0x10000000, 1); /* exponent */
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype));
		*(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) -ti4_1;
	}
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1327, dtype));
	if (tb1) {
		RTHOOK(4);
		RTDBGAA(Current, dtype, 1321, 0x20000000, 1); /* natural_part */
		tr8_2 = *(EIF_REAL_64 *)(Current + RTWA(1322, dtype));
		tr8_3 = *(EIF_REAL_64 *)(Current + RTWA(1323, dtype));
		(*(EIF_REAL_64 *)(Current + RTWA(1321, dtype))) += (EIF_REAL_64) ((EIF_REAL_64) (tr8_2) /  (EIF_REAL_64) (tr8_3));
	}
	RTHOOK(5);
	...
	if (tb1) {
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(1321, dtype));
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype));
...
EIF_TYPED_VALUE F88_1388 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1417);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x18000000, 1,0); /* Result */
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1319, dtype))(Current)).it_r8);
	RTNHOOK(1,1);
...
void F88_1389 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 87, Current, 0, 1, 1418);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_REAL_64 *)(Current + RTWA(1321, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 1322, 0x20000000, 1); /* fractional_part */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(1322, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 1323, 0x20000000, 1); /* fractional_divider */
	tr8_1 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
	*(EIF_REAL_64 *)(Current + RTWA(1323, dtype)) = (EIF_REAL_64) tr8_1;
	RTHOOK(8);
	RTDBGAA(Current, dtype, 1324, 0x10000000, 1); /* exponent */
	*(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(9);
	RTDBGAA(Current, dtype, 1325, 0x04000000, 1); /* is_negative */
	*(EIF_BOOLEAN *)(Current + RTWA(1325, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(10);
	RTDBGAA(Current, dtype, 1326, 0x04000000, 1); /* has_negative_exponent */
	*(EIF_BOOLEAN *)(Current + RTWA(1326, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(11);
	RTDBGAA(Current, dtype, 1327, 0x04000000, 1); /* has_fractional_part */
	*(EIF_BOOLEAN *)(Current + RTWA(1327, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(12);
	RTDBGAA(Current, dtype, 1328, 0x04000000, 1); /* needs_digit */
	*(EIF_BOOLEAN *)(Current + RTWA(1328, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(13);
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(1322, dtype));
		tr8_2 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN) eif_is_equal_real_64 (tr8_1, tr8_2)) {
			RTCK;
		} else {
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(1323, dtype));
		tr8_2 = (EIF_REAL_64) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN) eif_is_equal_real_64 (tr8_1, tr8_2)) {
			RTCK;
		} else {
...
void F88_1390 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 87, Current, 8, 2, 1419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1419);
	RTCC(arg1, 87, l_feature_name, 1, eif_new_type(261, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if (EIF_TEST(loc8)) {
			...
			for (;;) {
				...
				if (tb1) {
					...
					RTHOOK(19);
					RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
					*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
				}
				RTHOOK(20);
				RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
				loc1++;
...
void F88_1391 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 87, Current, 0, 1, 1420);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	switch (ti4_1) {
		case 0L:
			...
			if (tb1) {
				RTHOOK(3);
				RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
				RTHOOK(4);
				RTDBGAA(Current, dtype, 1321, 0x20000000, 1); /* natural_part */
				...
				*(EIF_REAL_64 *)(Current + RTWA(1321, dtype)) = (EIF_REAL_64) tr8_1;
				...
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+')) {
					RTHOOK(6);
					RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
					*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				} else {
					RTHOOK(7);
					if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-')) {
						RTHOOK(8);
						...
						*(EIF_BOOLEAN *)(Current + RTWA(1325, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
						...
						if (tb1) {
							...
							if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
								RTHOOK(12);
								RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
								*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
								RTHOOK(13);
								RTDBGAA(Current, dtype, 1328, 0x04000000, 1); /* needs_digit */
								*(EIF_BOOLEAN *)(Current + RTWA(1328, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
							} else {
								RTHOOK(14);
								RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
								*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 2L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(1321, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2) - tr8_3);
			} else {
				RTHOOK(24);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '.')) {
					RTHOOK(25);
					...
					*(EIF_BOOLEAN *)(Current + RTWA(1328, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
					...
					if (tb1) {
						RTHOOK(28);
						RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 8L);
					} else {
						RTHOOK(29);
						...
						if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
							RTHOOK(30);
							RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
						} else {
							RTHOOK(31);
							RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
							*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 3L:
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
				RTHOOK(34);
				RTDBGAA(Current, dtype, 1327, 0x04000000, 1); /* has_fractional_part */
				*(EIF_BOOLEAN *)(Current + RTWA(1327, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(35);
				RTDBGAA(Current, dtype, 1322, 0x20000000, 1); /* fractional_part */
				ti4_1 = (EIF_INTEGER_32) (arg1);
				tr8_1 = (EIF_REAL_64) ((EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L)));
				*(EIF_REAL_64 *)(Current + RTWA(1322, dtype)) = (EIF_REAL_64) tr8_1;
				RTHOOK(36);
				RTDBGAA(Current, dtype, 1323, 0x20000000, 1); /* fractional_divider */
				*(EIF_REAL_64 *)(Current + RTWA(1323, dtype)) = (EIF_REAL_64) (EIF_REAL_64) 10.0;
				RTHOOK(37);
				RTDBGAA(Current, dtype, 1328, 0x04000000, 1); /* needs_digit */
				*(EIF_BOOLEAN *)(Current + RTWA(1328, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			} else {
		...
		case 4L:
			...
			if (tb1) {
				...
				*(EIF_REAL_64 *)(Current + RTWA(1322, dtype)) = (EIF_REAL_64) (EIF_REAL_64) ((EIF_REAL_64) (tr8_1 * (EIF_REAL_64) 10.0) + tr8_2);
				RTHOOK(46);
				RTDBGAA(Current, dtype, 1323, 0x20000000, 1); /* fractional_divider */
				(*(EIF_REAL_64 *)(Current + RTWA(1323, dtype))) *= (EIF_REAL_64) 10.0;
			} else {
				RTHOOK(47);
				tc1 = eif_builtin_CHARACTER_8_as_lower__c1_c1(arg1);
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) 'e')) {
		...
		case 5L:
			...
			if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-')) {
				RTHOOK(54);
				RTDBGAA(Current, dtype, 1326, 0x04000000, 1); /* has_negative_exponent */
				*(EIF_BOOLEAN *)(Current + RTWA(1326, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(55);
				RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
				*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
			} else {
				RTHOOK(56);
				if ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+')) {
					RTHOOK(57);
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
					...
					if (tb1) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(1328, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
						RTHOOK(60);
						RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
						RTHOOK(61);
						RTDBGAA(Current, dtype, 1324, 0x10000000, 1); /* exponent */
						ti4_1 = (EIF_INTEGER_32) (arg1);
						*(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
					} else {
						RTHOOK(62);
						RTDBGAA(Current, dtype, 1312, 0x10000000, 1); /* last_state */
						*(EIF_INTEGER_32 *)(Current + RTWA(1312, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
		...
		case 7L:
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(1324, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (ti4_1 * ((EIF_INTEGER_32) 10L)) + ti4_2) - ((EIF_INTEGER_32) 48L));
			} else {
				RTHOOK(70);
				tb1 = '\0';
				tb2 = *(EIF_BOOLEAN *)(Current + RTWA(1295, dtype));
...
EIF_TYPED_VALUE F88_1392 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(1321,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F88_1393 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(1322,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F88_1394 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(1323,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F88_1397 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F88_1398 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F88_1399 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
