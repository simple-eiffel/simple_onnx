...
extern EIF_TYPED_VALUE F74_1253(EIF_REFERENCE);
...
EIF_TYPED_VALUE F74_1253 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1286);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,959,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3489, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
