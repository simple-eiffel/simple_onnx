...
extern void F94_1464(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 93, Current, 1, 0, 1483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1371, dtype))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(93, Current, 1485);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800008E, 0,0); /* Result */
...
void F94_1464 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 93, Current, 0, 1, 1486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(93, Current, 1486);
