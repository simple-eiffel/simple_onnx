...
extern EIF_TYPED_VALUE F36_743(EIF_REFERENCE);
extern EIF_TYPED_VALUE F36_744(EIF_REFERENCE);
extern EIF_TYPED_VALUE F36_745(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F36_738,820,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {363,0xFF01,266,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 35, Current, 0, 0, 822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 35, Current, 0, 0, 823);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F36_743 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F36_743,825,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F36_744 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F36_744,818,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F36_745 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F36_745,819,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
