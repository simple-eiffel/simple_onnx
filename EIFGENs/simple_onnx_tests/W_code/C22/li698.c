...
extern EIF_TYPED_VALUE F698_974(EIF_REFERENCE);
extern void F698_975(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F698_976(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F698_974 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F698_975 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 697, Current, 0, 1, 1024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 1024);
	RTCC(arg1, 697, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 938, 0xF80002B9, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F698_976 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 1025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 1025);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 938, 0xF80002B9, 0); /* right */
