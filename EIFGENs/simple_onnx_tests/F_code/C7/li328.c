...
/* {LINEAR}.has */
EIF_BOOLEAN F420_3365 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("has", 419, Current, 0, 1, 4391);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN) !(nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2934[dtype-564])(Current))) {
		RTHOOK(3);
		tr1 = RTCCL(arg1);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2941[dtype-564])(Current, tr1));
	}
	RTHOOK(4);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2945[dtype-564])(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F420_3366 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 419, Current, 2, 2, 4392);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O2927[dtype-389]) && (EIF_BOOLEAN)(arg1 != NULL))) {
		RTHOOK(3);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2935[dtype-564])(Current));
		RTHOOK(4);
		...
		for (;;) {
			...
			if (tb1) break;
			RTHOOK(6);
			if (RTEQ((nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2933[dtype-564])(Current)), arg1)) {
				RTHOOK(7);
				loc1++;
			}
			RTHOOK(8);
		...
		for (;;) {
			...
			if (tb2) break;
			RTHOOK(13);
			if (RTCEQ((nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2933[dtype-564])(Current)), arg1)) {
				RTHOOK(14);
				loc1++;
			}
			RTHOOK(15);
...
/* {LINEAR}.search */
void F420_3367 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("search", 419, Current, 0, 1, 4393);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F420_3369 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("occurrences", 419, Current, 0, 1, 4394);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2945[dtype-564])(Current))) break;
		RTHOOK(4);
		Result++;
		RTHOOK(5);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2948[dtype-564])(Current));
...
EIF_REFERENCE F420_3370 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item_for_iteration", 419, Current, 0, 0, 4395);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2933[dtype-564])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F420_3371 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 419, Current, 0, 0, 4396);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F420_3373 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 419, Current, 0, 0, 4397);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F420_3376 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 419, Current, 3, 1, 4398);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_if */
void F420_3377 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 419, Current, 3, 2, 4399);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F420_3378 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 419, Current, 3, 1, 4400);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F420_3379 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 419, Current, 3, 1, 4388);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F420_3380 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("linear_representation", 419, Current, 0, 0, 4389);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F420_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 327, Current, 0, 0);
