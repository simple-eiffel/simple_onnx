...
/* {CONTAINER}.empty */
EIF_BOOLEAN F390_3351 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("empty", 389, Current, 0, 0, 4216);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F390_3352 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F390_3353 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("changeable_comparison_criterion", 389, Current, 0, 0, 4218);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F390_3354 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_objects", 389, Current, 0, 0, 4219);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F390_3355 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_references", 389, Current, 0, 0, 4220);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F390_3357 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("estimated_count_of", 389, Current, 2, 1, 4221);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
