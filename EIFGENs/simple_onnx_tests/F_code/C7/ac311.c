...
/* {ACTIVE}.replaceable */
EIF_BOOLEAN F518_3412 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("replaceable", 517, Current, 0, 0, 4697);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F518_1 (EIF_REFERENCE Current, int where)
{
	...
	tb1 = '\01';
	if ((nstcall = 0, F618_3476(Current))) {
	...
	if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2925[dtype-564])(Current))) {
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2970[dtype-564])(Current))) {
			tb2 = (EIF_BOOLEAN) !(nstcall = 0, F618_3476(Current));
		}
		tb1 = tb2;
	}
	if (tb1) {
