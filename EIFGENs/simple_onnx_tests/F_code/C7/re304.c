...
EIF_REFERENCE F649_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 648, Current, 0, 0, 5385);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 305, _OBJSIZ_1_1_0_4_0_0_0_0_);
	}
	(nstcall = -1, F306_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F649_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 648, Current, 0, 0, 5386);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F649_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 303, Current, 0, 0);
