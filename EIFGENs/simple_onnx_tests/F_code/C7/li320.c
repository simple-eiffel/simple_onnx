...
/* {LIST}.is_equal */
EIF_BOOLEAN F724_4002 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_equal", 723, Current, 2, 1, 6818);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2925[dtype-564])(Current)) == tb2)) {
		...
		if (tb1) {
			...
			if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2925[dtype-564])(Current))) {
				tb4 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2925[Dtype(RTCW(arg1))-564])(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F724_4003 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 723, Current, 0, 0, 6819);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}.before */
EIF_BOOLEAN F724_4004 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("before", 723, Current, 0, 0, 6820);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}._invariant */
void F724_1 (EIF_REFERENCE Current, int where)
{
	GTCX
