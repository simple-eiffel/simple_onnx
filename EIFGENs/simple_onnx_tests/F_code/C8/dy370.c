...
EIF_BOOLEAN F709_3988 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 708, Current, 0, 0, 6730);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F709_3994 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("prune", 708, Current, 0, 1, 6731);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F709_3995 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("prune_all", 708, Current, 0, 1, 6732);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F709_3998 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 708, Current, 3, 1, 6733);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 < arg1)) {
				tr8 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc2)-245])(loc2));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc2)-304])(loc2));
				tr9 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2962[dtype-677])(Current, (EIF_REFERENCE) &ti4_4));
				tb3 = RTCEQ(tr8, tr9);
			}
			tb1 = tb3;
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tr8 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc3)-245])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc3)-304])(loc3));
				ti4_5 = (EIF_INTEGER_32) (ti4_4 - ((EIF_INTEGER_32) 1L));
				tr9 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2962[dtype-677])(Current, (EIF_REFERENCE) &ti4_5));
				tb3 = RTCEQ(tr8, tr9);
			}
			tb1 = tb3;
...
void F709_3999 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("wipe_out", 708, Current, 0, 0, 6728);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2925[dtype-564])(Current))) break;
		RTHOOK(4);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2974[dtype-564])(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F709_4000 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 708, Current, 2, 1, 6729);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
