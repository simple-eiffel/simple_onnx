...
EIF_INTEGER_32 F597_3458 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("additional_space", 596, Current, 0, 0, 4827);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {RESIZABLE}.resizable */
EIF_BOOLEAN F597_3459 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("resizable", 596, Current, 0, 0, 4828);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F597_3460 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("automatic_grow", 596, Current, 0, 0, 4829);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
