...
EIF_INTEGER_32 F596_3458 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("additional_space", 595, Current, 0, 0, 4821);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {RESIZABLE}.resizable */
EIF_BOOLEAN F596_3459 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("resizable", 595, Current, 0, 0, 4822);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F596_3460 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("automatic_grow", 595, Current, 0, 0, 4823);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
