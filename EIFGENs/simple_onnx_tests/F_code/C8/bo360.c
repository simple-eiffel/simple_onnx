...
/* {BOUNDED}.full */
EIF_BOOLEAN F581_3454 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 580, Current, 0, 0, 4789);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F581_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 359, Current, 0, 0);
