...
void F171_1840 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 170, Current, 0, 3, 1851);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F171_1841 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F171_1842 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F171_1843 (EIF_REFERENCE Current)
{
...
void F171_1 (EIF_REFERENCE Current, int where)
{
	GTCX
