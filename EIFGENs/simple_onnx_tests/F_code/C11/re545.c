...
EIF_INTEGER_32 F600_3458 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("additional_space", 599, Current, 0, 0, 4845);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {RESIZABLE}.resizable */
EIF_BOOLEAN F600_3459 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("resizable", 599, Current, 0, 0, 4846);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F600_3460 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("automatic_grow", 599, Current, 0, 0, 4847);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F600_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 544, Current, 0, 0);
