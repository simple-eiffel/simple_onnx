...
/* {CELL}.item */
EIF_CHARACTER_32 F72_971 (EIF_REFERENCE Current)
{
...
/* {CELL}.put */
void F72_972 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
...
/* {CELL}.replace */
void F72_973 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("replace", 71, Current, 0, 1, 1019);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
