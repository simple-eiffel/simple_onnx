...
void F802_4236 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 801, Current, 0, 4, 8329);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F802_4237 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3)
{
	GTCX
	RTEX;
	...
	RTEAA("local_value_at", 801, Current, 1, 3, 8330);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F802_4238 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3, EIF_CHARACTER_32 arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("set_local_value_at", 801, Current, 2, 4, 8331);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_32 F802_4239 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F802_4240 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F802_4241 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F802_4242 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("current_value_record", 801, Current, 0, 0, 8335);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F194_2426(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_4_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_0_1_)));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REFERENCE F802_4243 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("associated_object", 801, Current, 0, 0, 8336);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F802_4244 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_TRUE;
}

/* {RT_DBG_LOCAL_RECORD}.is_same_as */
EIF_BOOLEAN F802_4245 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 801, Current, 1, 1, 8338);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F802_4246 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 801, Current, 0, 0, 8339);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F802_4247 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 801, Current, 1, 0, 8322);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_3_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F802_4252(Current, loc1));
			} else {
				RTHOOK(11);
				Result = RTLNS(eif_new_type(969, 0x01).id, 969, _OBJSIZ_1_1_0_3_0_0_0_0_);
				(nstcall = -1, F965_5930(RTCW(Result)));
...
void F802_4248 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_CHARACTER_32 loc1 = (EIF_CHARACTER_32) 0;
	...
	RTEAA("get_value", 801, Current, 1, 0, 8323);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr2 = (nstcall = 0, F802_4237(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_4_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_0_1_)));
	tr1 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_CHARACTER_32 *)(Current+ _LNGOFF_1_0_0_0_) = (EIF_CHARACTER_32) loc1;
		...
		RTHOOK(3);
		tw1 = (nstcall = 0, F802_4253(Current));
...
void F802_4249 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("restore", 801, Current, 0, 1, 8324);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F802_4245(Current, arg1))) {
	} else {
		RTHOOK(3);
		(nstcall = 0, F802_4251(Current, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F802_4250 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("revert", 801, Current, 0, 1, 8325);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(nstcall = 0, F802_4251(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F802_4251 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_local_from_record", 801, Current, 1, 1, 8326);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = arg1;
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,801,0xFF02,0xFFF8,1,0xFFFF};
		EIF_TYPE typres0;
	...
	if (EIF_TEST(loc1)) {
		...
		tw1 = *(EIF_CHARACTER_32 *)(loc1+ _LNGOFF_1_0_0_0_);
		(nstcall = 0, F802_4238(Current, ti4_1, ti4_2, tu4_1, tw1));
	} else {
...
EIF_REFERENCE F802_4252 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 801, Current, 0, 1, 8327);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_32 F802_4253 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 801, Current, 0, 0, 8328);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
