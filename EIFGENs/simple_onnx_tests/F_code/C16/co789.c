...
EIF_BOOLEAN F460_3387 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 459, Current, 0, 1, 4645);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F460_3390 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 459, Current, 1, 1, 4646);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2955[dtype-564])(Current, (EIF_REFERENCE) &ti2_1));
		RTHOOK(7);
...
void F460_3392 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 459, Current, 0, 1, 4647);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
