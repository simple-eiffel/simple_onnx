...
/* {FINITE}.is_empty */
EIF_BOOLEAN F575_3452 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("is_empty", 574, Current, 0, 0, 4777);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F575_1 (EIF_REFERENCE Current, int where)
{
	...
	if ((EIF_BOOLEAN)((nstcall = 0, F575_3452(Current)) == (EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2989[Dtype(Current)-644])(Current)) == ((EIF_INTEGER_32) 0L)))) {
		RTCK;
	} else {
		RTCF;
	}
