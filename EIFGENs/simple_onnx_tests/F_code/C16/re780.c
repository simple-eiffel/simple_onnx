...
EIF_REFERENCE F658_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 657, Current, 0, 0, 5415);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 314, _OBJSIZ_1_1_0_4_0_0_0_0_);
	}
	(nstcall = -1, F315_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F658_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 657, Current, 0, 0, 5416);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F658_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 779, Current, 0, 0);
