...
void F783_4220 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4, EIF_NATURAL_64 arg5)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 782, Current, 0, 5, 7980);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F783_4221 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_64 F783_4222 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F783_4223 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F783_4224 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("current_value_record", 782, Current, 0, 0, 7984);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F783_4225 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("associated_object", 782, Current, 0, 0, 7985);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F783_4226 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_FALSE;
}

/* {RT_DBG_ATTRIBUTE_RECORD}.is_same_as */
EIF_BOOLEAN F783_4227 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 782, Current, 1, 1, 7987);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F783_4228 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 782, Current, 0, 0, 7988);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F783_4229 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 782, Current, 1, 0, 7989);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_0_0_2_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F783_4234(Current, loc1));
			} else {
...
void F783_4230 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_64 loc1 = (EIF_NATURAL_64) 0;
	...
	RTEAA("get_value", 782, Current, 1, 0, 7990);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (tb1) {
		...
		*(EIF_NATURAL_64 *)(Current+ _I64OFF_2_0_0_3_0_0_0_) = (EIF_NATURAL_64) loc1;
		...
		RTHOOK(3);
		tu8_1 = (nstcall = 0, F783_4235(Current));
...
void F783_4231 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("restore", 782, Current, 1, 1, 7991);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F783_4227(Current, arg1))) {
	} else {
		RTHOOK(3);
		tr1 = *(EIF_REFERENCE *)(Current + _REFACS_1_);
		tr2 = RTCCL(tr1);
		(nstcall = 0, F783_4233(Current, tr2, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F783_4232 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("revert", 782, Current, 0, 1, 7992);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr1 = *(EIF_REFERENCE *)(Current + _REFACS_1_);
	tr2 = RTCCL(tr1);
	(nstcall = 0, F783_4233(Current, tr2, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F783_4233 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_attribute_from_record", 782, Current, 1, 2, 7993);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = arg2;
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,782,0xFF02,0xFFF8,1,0xFFFF};
		EIF_TYPE typres0;
...
EIF_REFERENCE F783_4234 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 782, Current, 0, 1, 7994);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_64 F783_4235 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 782, Current, 0, 0, 7995);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
