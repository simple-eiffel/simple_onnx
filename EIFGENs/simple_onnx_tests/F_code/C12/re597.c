...
EIF_REFERENCE F654_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 653, Current, 0, 0, 5403);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F311_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F654_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 653, Current, 0, 0, 5404);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
