...
EIF_REFERENCE F653_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 652, Current, 0, 0, 5400);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F653_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 652, Current, 0, 0, 5401);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
