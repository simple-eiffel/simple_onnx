...
EIF_BOOLEAN F455_3387 (EIF_REFERENCE Current, EIF_NATURAL_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 454, Current, 0, 1, 4630);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F455_3390 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 454, Current, 1, 1, 4631);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2955[dtype-564])(Current, (EIF_REFERENCE) &tu4_1));
		RTHOOK(7);
...
void F455_3392 (EIF_REFERENCE Current, EIF_NATURAL_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 454, Current, 0, 1, 4632);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
