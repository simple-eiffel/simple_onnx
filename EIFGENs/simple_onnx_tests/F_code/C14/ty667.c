...
EIF_NATURAL_8 F297_3241 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 296, Current, 0, 0, 3287);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tu1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R3211[Dtype(RTCW(tr1))-677])(tr1, ti4_1));
