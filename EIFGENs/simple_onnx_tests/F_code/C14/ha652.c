...
EIF_INTEGER_32 F326_3274 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 325, Current, 0, 0, 3640);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F326_3277(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	ti4_1 = (nstcall = 1, F761_4161(RTCW(tr2), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_3_)));
...
EIF_INTEGER_32 F326_3275 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("key", 325, Current, 0, 0, 3641);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F326_3276 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 325, Current, 3, 0, 3642);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
		...
		for (;;) {
			...
			RTHOOK(7);
			tr1 = *(EIF_REFERENCE *)(Current);
			ti4_1 = (nstcall = 1, F848_4506(RTCW(tr1), loc1));
			loc1 = (EIF_INTEGER_32) ti4_1;
			RTHOOK(8);
			loc2--;
			RTHOOK(9);
		...
		for (;;) {
			...
			RTHOOK(14);
			tr1 = *(EIF_REFERENCE *)(Current);
			ti4_1 = (nstcall = 1, F848_4505(RTCW(tr1), loc1));
			loc1 = (EIF_INTEGER_32) ti4_1;
			RTHOOK(15);
			loc2--;
			RTHOOK(16);
...
EIF_BOOLEAN F326_3277 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("after", 325, Current, 1, 0, 3643);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F326_3278 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("forth", 325, Current, 3, 0, 3644);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F326_3276(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
		RTE_OT
		ti4_2 = (nstcall = 0, F326_3276(Current));
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
		RTE_OE
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
		...
		for (;;) {
			...
			ti4_3 = (nstcall = 1, F848_4506(RTCW(tr3), loc3));
		...
		for (;;) {
			...
			RTHOOK(11);
			tr3 = *(EIF_REFERENCE *)(Current);
			ti4_3 = (nstcall = 1, F848_4505(RTCW(tr3), loc3));
			loc3 = (EIF_INTEGER_32) ti4_3;
			RTHOOK(12);
			loc1++;
		}
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_3_) = (EIF_INTEGER_32) loc3;
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F326_3276(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		RTCT("cursor_index_advanced", EX_POST);
		RTCO(tr2);
		if ((EIF_BOOLEAN)((nstcall = 0, F326_3276(Current)) == (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F326_3279 (EIF_REFERENCE Current)
{
