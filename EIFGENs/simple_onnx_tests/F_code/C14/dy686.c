...
EIF_BOOLEAN F716_3988 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 715, Current, 0, 0, 6772);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F716_3994 (EIF_REFERENCE Current, EIF_NATURAL_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 715, Current, 0, 1, 6773);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F716_3995 (EIF_REFERENCE Current, EIF_NATURAL_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 715, Current, 0, 1, 6774);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F716_3998 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 715, Current, 3, 1, 6775);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F832_4398(Current));
	RTHOOK(8);
	(nstcall = 0, F832_4379(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tu1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc3)-245])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc3)-304])(loc3));
...
void F716_3999 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 715, Current, 0, 0, 6770);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F573_3452(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F832_4398(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F716_4000 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 715, Current, 2, 1, 6771);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F832_4406(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2927[dtype-389])) {
		RTHOOK(5);
		(nstcall = 1, F397_3354(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		(nstcall = 1, F832_4385(RTCW(Result), tu1_1));
		RTHOOK(9);
