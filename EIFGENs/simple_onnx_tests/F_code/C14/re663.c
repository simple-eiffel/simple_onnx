...
EIF_REFERENCE F655_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 654, Current, 0, 0, 5406);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F312_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F655_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 654, Current, 0, 0, 5407);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
