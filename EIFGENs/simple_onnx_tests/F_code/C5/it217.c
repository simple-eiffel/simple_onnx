...
/* {ITP_VARIABLE}.make */
void F854_4599 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 853, Current, 0, 1, 10335);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {ITP_VARIABLE}.name */
EIF_REFERENCE F854_4600 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("name", 853, Current, 0, 1, 10336);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_0_0_0_0_);
		tr1 = eif_out__i4_s1(ti4_1);
		tr1 = (nstcall = 1, F970_6192(RTCW(arg1), tr1));
		tb1 = (nstcall = 1, F968_6085(RTCW(Result), tr1));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_INTEGER_32 F854_4601 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("hash_code", 853, Current, 0, 0, 10337);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		RTHOOK(3);
		RTCT("good_result", EX_POST);
		if ((EIF_BOOLEAN)(Result == *(EIF_INTEGER_32 *)(Current+ _LNGOFF_0_0_0_0_))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_BOOLEAN F854_4602 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_equal", 853, Current, 0, 1, 10338);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)(Result == (EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_0_0_0_0_) == ti4_1))) {
			RTCK;
		} else {
			RTCF;
		}
...
/* {ITP_VARIABLE}.index */
EIF_INTEGER_32 F854_4603 (EIF_REFERENCE Current)
{
...
void F854_4604 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("process", 853, Current, 0, 1, 10340);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
