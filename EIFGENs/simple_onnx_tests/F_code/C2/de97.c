...
EIF_INTEGER_32 F118_1498 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 117, Current, 0, 0, 1520);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F118_1499_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 117, Current, 0, 0, 1521);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F118_1499 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(104,F118_1499_body,(Current));
}
