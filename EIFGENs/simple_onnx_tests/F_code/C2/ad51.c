...
/* {ADDRINFO}.af_inet */
EIF_INTEGER_32 F66_933 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("af_inet", 65, Current, 0, 0, 978);
	RTSA(Dtype(Current));
	RTSC;
...
/* {ADDRINFO}.af_inet6 */
EIF_INTEGER_32 F66_934 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("af_inet6", 65, Current, 0, 0, 979);
	RTSA(Dtype(Current));
	RTSC;
