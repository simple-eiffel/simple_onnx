...
EIF_BOOLEAN F456_3387 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 455, Current, 0, 1, 4633);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F456_3390 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 455, Current, 1, 1, 4634);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2955[dtype-564])(Current, (EIF_REFERENCE) &tp1));
		RTHOOK(7);
...
void F456_3392 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 455, Current, 0, 1, 4635);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
