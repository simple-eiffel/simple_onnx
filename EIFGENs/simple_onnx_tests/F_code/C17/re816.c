...
EIF_REFERENCE F659_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 658, Current, 0, 0, 5418);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F316_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F659_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 658, Current, 0, 0, 5419);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F659_1 (EIF_REFERENCE Current, int where)
{
	GTCX
