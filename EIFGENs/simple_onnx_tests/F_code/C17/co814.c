...
/* {CONTAINER}.empty */
EIF_BOOLEAN F401_3351 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("empty", 400, Current, 0, 0, 4276);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F577_3452(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F401_3352 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F401_3353 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("changeable_comparison_criterion", 400, Current, 0, 0, 4278);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F401_3354 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_objects", 400, Current, 0, 0, 4279);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F401_3353(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
void F401_3355 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_references", 400, Current, 0, 0, 4280);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F401_3357 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("estimated_count_of", 400, Current, 2, 1, 4281);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
