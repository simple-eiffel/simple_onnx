...
/* {BILINEAR}.off */
EIF_BOOLEAN F443_3381 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 442, Current, 0, 0, 4594);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F443_3384 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 442, Current, 0, 1, 4595);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F428_3367(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
