...
void F747_4006 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("put_left", 746, Current, 1, 1, 6910);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((nstcall = 0, F574_3452(Current))) {
		RTHOOK(4);
		(nstcall = 0, F833_4382(Current, arg1));
	} else {
		RTHOOK(5);
		if ((nstcall = 0, F732_4003(Current))) {
			RTHOOK(6);
			(nstcall = 0, F833_4378(Current));
			RTHOOK(7);
			(nstcall = 0, F833_4387(Current, arg1));
			RTHOOK(8);
			(nstcall = 0, F833_4374(Current, ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(9);
			loc1 = (nstcall = 0, F833_4349(Current));
			RTHOOK(10);
			(nstcall = 0, F833_4388(Current, arg1));
			RTHOOK(11);
			(nstcall = 0, F833_4387(Current, loc1));
			RTHOOK(12);
...
void F747_4008 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_left", 746, Current, 0, 1, 6911);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr4_1 = (nstcall = 1, F833_4349(RTCW(arg1)));
		(nstcall = 0, F833_4386(Current, tr4_1));
		RTHOOK(8);
		(nstcall = 1, F833_4398(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("new_count", EX_POST);
...
void F747_4009 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_right", 746, Current, 0, 1, 6912);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(7);
		tr4_1 = (nstcall = 1, F833_4349(RTCW(arg1)));
		(nstcall = 0, F833_4387(Current, tr4_1));
		RTHOOK(8);
		(nstcall = 1, F833_4378(RTCW(arg1)));
		RTHOOK(9);
		(nstcall = 1, F833_4402(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
		RTCT("new_count", EX_POST);
...
void F747_4013 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 746, Current, 0, 0, 6913);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
