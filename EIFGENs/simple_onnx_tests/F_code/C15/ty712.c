...
EIF_REAL_32 F298_3241 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 297, Current, 0, 0, 3288);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr4_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_REAL_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R3211[Dtype(RTCW(tr1))-677])(tr1, ti4_1));
