...
EIF_BOOLEAN F458_3387 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 457, Current, 0, 1, 4639);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F458_3390 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 457, Current, 1, 1, 4640);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	(nstcall = 1, F833_4375(RTCW(loc1)));
	for (;;) {
		RTHOOK(5);
		tb1 = '\01';
		if (!(EIF_BOOLEAN) !(nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2951[dtype-564])(Current))) {
			tb2 = (nstcall = 1, F702_3979(RTCW(loc1)));
			tb1 = tb2;
		}
		if (tb1) break;
		RTHOOK(6);
		tr4_1 = (nstcall = 1, F833_4349(RTCW(loc1)));
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2955[dtype-564])(Current, (EIF_REFERENCE) &tr4_1));
		RTHOOK(7);
		(nstcall = 1, F833_4377(RTCW(loc1)));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
...
void F458_3392 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 457, Current, 0, 1, 4641);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
