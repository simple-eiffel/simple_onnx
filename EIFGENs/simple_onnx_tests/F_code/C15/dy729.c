...
EIF_BOOLEAN F717_3988 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 716, Current, 0, 0, 6778);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F717_3994 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 716, Current, 0, 1, 6779);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F717_3995 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 716, Current, 0, 1, 6780);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F717_3998 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 716, Current, 3, 1, 6781);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(6);
	(nstcall = 0, F833_4379(Current, arg1));
	RTHOOK(7);
	(nstcall = 0, F833_4398(Current));
	RTHOOK(8);
	(nstcall = 0, F833_4379(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tr4_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_REAL_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc3)-245])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc3)-304])(loc3));
...
void F717_3999 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 716, Current, 0, 0, 6776);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F574_3452(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F833_4398(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F717_4000 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 716, Current, 2, 1, 6777);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F833_4406(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2927[dtype-389])) {
		RTHOOK(5);
		(nstcall = 1, F398_3354(RTCW(Result)));
	}
	RTHOOK(6);
	loc1 = (nstcall = 0, F833_4355(Current));
	for (;;) {
		RTHOOK(7);
		tb1 = '\01';
		...
		(nstcall = 1, F833_4385(RTCW(Result), tr4_1));
		RTHOOK(9);
