...
EIF_REFERENCE F656_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 655, Current, 0, 0, 5409);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F313_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F656_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 655, Current, 0, 0, 5410);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
