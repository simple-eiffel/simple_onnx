...
EIF_INTEGER_32 F604_3458 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("additional_space", 603, Current, 0, 0, 4869);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {RESIZABLE}.resizable */
EIF_BOOLEAN F604_3459 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("resizable", 603, Current, 0, 0, 4870);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F604_3460 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("automatic_grow", 603, Current, 0, 0, 4871);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
