...
EIF_INTEGER_32 F135_1543 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 134, Current, 0, 0, 1565);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F135_1544_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 134, Current, 0, 0, 1566);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F135_1544 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(103,F135_1544_body,(Current));
}
