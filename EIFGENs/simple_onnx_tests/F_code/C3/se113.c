...
EIF_INTEGER_32 F134_1541 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 133, Current, 0, 0, 1563);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F134_1542_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 133, Current, 0, 0, 1564);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F134_1542 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(108,F134_1542_body,(Current));
}
