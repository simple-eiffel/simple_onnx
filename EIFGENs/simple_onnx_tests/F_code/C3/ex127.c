...
EIF_INTEGER_32 F148_1571 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 147, Current, 0, 0, 1593);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F148_1572_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 147, Current, 0, 0, 1594);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F148_1572 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(100,F148_1572_body,(Current));
}
