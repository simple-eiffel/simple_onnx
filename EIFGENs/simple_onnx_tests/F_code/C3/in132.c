...
EIF_INTEGER_32 F153_1579 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 152, Current, 0, 0, 1603);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F153_1580 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_is_entry", 152, Current, 0, 1, 1604);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F153_1581_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 152, Current, 0, 0, 1601);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F153_1581 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(114,F153_1581_body,(Current));
}

/* {INVARIANT_VIOLATION}.is_entry */
EIF_BOOLEAN F153_1582 (EIF_REFERENCE Current)
{
