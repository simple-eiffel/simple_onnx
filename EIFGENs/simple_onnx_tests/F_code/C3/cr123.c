...
EIF_INTEGER_32 F144_1565 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 143, Current, 0, 0, 1587);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F144_1566_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 143, Current, 0, 0, 1588);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F144_1566 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(97,F144_1566_body,(Current));
}
