...
EIF_INTEGER_32 F150_1573 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 149, Current, 0, 0, 1595);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F150_1574_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 149, Current, 0, 0, 1596);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F150_1574 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(119,F150_1574_body,(Current));
}
