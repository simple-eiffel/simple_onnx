...
EIF_INTEGER_32 F123_1502 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 122, Current, 0, 0, 1524);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F123_1503 (EIF_REFERENCE Current)
{
...
static EIF_REFERENCE F123_1504_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 122, Current, 0, 0, 1526);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F123_1504 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(120,F123_1504_body,(Current));
}

/* {OPERATING_SYSTEM_SIGNAL_FAILURE}.set_signal_code */
void F123_1505 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_signal_code", 122, Current, 0, 1, 1527);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
