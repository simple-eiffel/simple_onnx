...
EIF_INTEGER_32 F155_1585 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 154, Current, 0, 0, 1607);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F155_1586_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 154, Current, 0, 0, 1608);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F155_1586 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(111,F155_1586_body,(Current));
}
