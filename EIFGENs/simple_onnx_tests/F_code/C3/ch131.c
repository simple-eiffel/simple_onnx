...
EIF_INTEGER_32 F152_1577 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 151, Current, 0, 0, 1599);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {CHECK_VIOLATION}.tag */
static EIF_REFERENCE F152_1578_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 151, Current, 0, 0, 1600);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F152_1578 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(115,F152_1578_body,(Current));
}
