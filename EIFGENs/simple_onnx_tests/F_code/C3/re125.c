...
EIF_INTEGER_32 F146_1567 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 145, Current, 0, 0, 1589);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F146_1568_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 145, Current, 0, 0, 1590);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F146_1568 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(123,F146_1568_body,(Current));
}
