...
void F317_3247 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 316, Current, 0, 1, 3560);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		...
		if ((nstcall = 0, F317_3260(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_INTEGER_32 F317_3248 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 316, Current, 0, 0, 3561);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F317_3260(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_INTEGER_32 F317_3249 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F317_3250 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F317_3251 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F317_3252 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F317_3253 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 316, Current, 0, 0, 3566);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F317_3254 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("reversed", 316, Current, 0, 0, 3567);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F317_3255 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("incremented", 316, Current, 0, 1, 3547);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	Result = (nstcall = 0, F1_14(Current));
	RTHOOK(3);
	(nstcall = 1, F317_3264(RTCW(Result), (EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) + arg1)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_REFERENCE F317_3256 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("decremented", 316, Current, 0, 1, 3548);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F317_3257 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("with_step", 316, Current, 0, 1, 3549);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F317_3258 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("after", 316, Current, 0, 0, 3550);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = '\01';
	if (!(EIF_BOOLEAN) !(nstcall = 0, F317_3260(Current))) {
...
EIF_BOOLEAN F317_3259 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F317_3260 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_valid", 316, Current, 0, 0, 3552);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F317_3261 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_first", 316, Current, 0, 0, 3553);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_3_) == *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_2_))) {
		Result = (nstcall = 0, F317_3260(Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_BOOLEAN F317_3262 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_last", 316, Current, 0, 0, 3554);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F317_3263 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("reverse", 316, Current, 0, 0, 3555);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F317_3264 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_step", 316, Current, 0, 1, 3556);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F317_3265 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("start", 316, Current, 1, 0, 3557);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_3_) = (EIF_INTEGER_32) *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_2_);
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F317_3248(Current)) == ((EIF_INTEGER_32) 1L))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((nstcall = 0, F317_3261(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F317_3266 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("forth", 316, Current, 0, 0, 3558);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F317_3258(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F317_3248(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
		RTE_OT
		ti4_2 = (nstcall = 0, F317_3248(Current));
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
		RTE_OE
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr2);
		if ((EIF_BOOLEAN)((nstcall = 0, F317_3248(Current)) == (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		RTCT("cursor_index_advanced", EX_POST);
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F317_3248(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F317_3267 (EIF_REFERENCE Current)
{
