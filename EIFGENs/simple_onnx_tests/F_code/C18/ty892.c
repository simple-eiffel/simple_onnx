...
EIF_NATURAL_16 F303_3241 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 302, Current, 0, 0, 3293);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tu2_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_16 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R3211[Dtype(RTCW(tr1))-677])(tr1, ti4_1));
