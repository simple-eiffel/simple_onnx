...
EIF_REFERENCE F662_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 661, Current, 0, 0, 5427);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F319_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F662_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 661, Current, 0, 0, 5428);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
