...
EIF_BOOLEAN F464_3387 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 463, Current, 0, 1, 4657);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F464_3390 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 463, Current, 1, 1, 4658);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2955[dtype-564])(Current, (EIF_REFERENCE) &tb2));
		RTHOOK(7);
...
void F464_3392 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 463, Current, 0, 1, 4659);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
