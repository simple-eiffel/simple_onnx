...
void F361_3318 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 360, Current, 0, 1, 4051);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_0_0_1_) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ti4_2);
	if (RTAL & CK_ENSURE) {
		...
		if ((nstcall = 0, F361_3321(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_INTEGER_32 F361_3319 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F361_3320 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 360, Current, 0, 0, 4053);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F361_3318(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_BOOLEAN F361_3321 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 360, Current, 0, 0, 4054);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F361_3322 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F361_3323 (EIF_REFERENCE Current)
{
