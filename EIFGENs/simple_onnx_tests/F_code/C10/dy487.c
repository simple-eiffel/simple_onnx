...
EIF_BOOLEAN F711_3988 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 710, Current, 0, 0, 6742);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F711_3994 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 710, Current, 0, 1, 6743);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F711_3995 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 710, Current, 0, 1, 6744);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F827_4356(Current, arg1))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F711_3998 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 710, Current, 3, 1, 6745);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F827_4398(Current));
	RTHOOK(8);
	(nstcall = 0, F827_4379(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("new_count", EX_POST);
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F827_4365(Current)) == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		RTCO(tr3);
		tr6 = (nstcall = 1, F827_4358(RTCV(tr2)));
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 < arg1)) {
				tu8_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc2)-245])(loc2));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc2)-304])(loc2));
				tb3 = (EIF_BOOLEAN)(tu8_1 == (nstcall = 0, F827_4350(Current, ti4_4)));
			}
			tb1 = tb3;
		...
		RTCO(tr5);
		tr6 = (nstcall = 1, F827_4358(RTCV(tr4)));
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tu8_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2814[Dtype(loc3)-245])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2863[Dtype(loc3)-304])(loc3));
				tb3 = (EIF_BOOLEAN)(tu8_1 == (nstcall = 0, F827_4350(Current, (EIF_INTEGER_32) (ti4_4 - ((EIF_INTEGER_32) 1L)))));
			}
			tb1 = tb3;
...
void F711_3999 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 710, Current, 0, 0, 6740);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F570_3452(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F827_4398(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F711_4000 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 710, Current, 2, 1, 6741);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F827_4406(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2927[dtype-389])) {
		RTHOOK(5);
		(nstcall = 1, F394_3354(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		if (!(EIF_BOOLEAN)(loc2 == arg1)) {
			tb1 = (nstcall = 0, F424_3371(Current));
		}
		if (tb1) break;
		RTHOOK(8);
		tu8_1 = (nstcall = 0, F827_4349(Current));
		(nstcall = 1, F827_4385(RTCW(Result), tu8_1));
		RTHOOK(9);
