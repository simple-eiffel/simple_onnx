...
/* {CONTAINER}.empty */
EIF_BOOLEAN F393_3351 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("empty", 392, Current, 0, 0, 4228);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F569_3452(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F393_3352 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F393_3353 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("changeable_comparison_criterion", 392, Current, 0, 0, 4230);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F393_3354 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_objects", 392, Current, 0, 0, 4231);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2928[dtype-564])(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
void F393_3355 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_references", 392, Current, 0, 0, 4232);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F393_3357 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("estimated_count_of", 392, Current, 2, 1, 4233);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
