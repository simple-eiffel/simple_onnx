...
EIF_REFERENCE F651_3861 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 650, Current, 0, 0, 5394);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F308_3247(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F651_3864 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 650, Current, 0, 0, 5395);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
