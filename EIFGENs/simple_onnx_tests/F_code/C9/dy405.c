...
void F740_4006 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("put_left", 739, Current, 1, 1, 6882);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((nstcall = 0, F568_3452(Current))) {
		RTHOOK(4);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R3283[dtype-753])(Current, (EIF_REFERENCE) &arg1));
	} else {
		RTHOOK(5);
		if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2946[dtype-564])(Current))) {
			...
			RTHOOK(7);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R3285[dtype-753])(Current, (EIF_REFERENCE) &arg1));
			RTHOOK(8);
			...
			RTHOOK(11);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R3285[dtype-753])(Current, (EIF_REFERENCE) &loc1));
			RTHOOK(12);
...
void F740_4008 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_left", 739, Current, 0, 1, 6883);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		ti4_5 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2969[Dtype(RTCW(arg1))-564])(arg1));
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R3284[dtype-753])(Current, (EIF_REFERENCE) &ti4_5));
		RTHOOK(8);
...
void F740_4009 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_right", 739, Current, 0, 1, 6884);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R3285[dtype-753])(Current, (EIF_REFERENCE) &ti4_4));
		RTHOOK(8);
...
void F740_4013 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("wipe_out", 739, Current, 0, 0, 6885);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
