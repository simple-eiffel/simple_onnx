...
/* {BILINEAR}.off */
EIF_BOOLEAN F436_3381 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 435, Current, 0, 0, 4573);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F436_3384 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 435, Current, 0, 1, 4574);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F422_3367(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if (tb2) {
			tb1 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2933[dtype-564])(Current)));
		}
		if (tb1) {
			RTCK;
		} else {
...
void F436_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 409, Current, 0, 0);
