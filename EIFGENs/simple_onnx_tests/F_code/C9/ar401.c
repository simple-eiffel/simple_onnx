...
void F343_3300 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 342, Current, 0, 1, 3943);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + _REFACS_1_) = (EIF_REFERENCE) arg1;
	...
	tr2 = (nstcall = 1, F826_4348(RTCW(tr1)));
	RTAR(Current, tr2);
	*(EIF_REFERENCE *)(Current) = (EIF_REFERENCE) tr2;
	RTHOOK(4);
	ti4_1 = (nstcall = 1, F826_4367(RTCW(arg1)));
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_0_0_1_) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L));
	if (RTAL & CK_ENSURE) {
		...
		if ((nstcall = 0, F343_3303(Current))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		ti4_1 = (nstcall = 1, F826_4367(RTCW(arg1)));
		if ((EIF_BOOLEAN)((nstcall = 0, F328_3283(Current)) == ti4_1)) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_INTEGER_32 F343_3301 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
}

/* {ARRAYED_LIST_ITERATION_CURSOR}.new_cursor */
EIF_REFERENCE F343_3302 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 342, Current, 0, 0, 3945);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F343_3300(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_BOOLEAN F343_3303 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 342, Current, 0, 0, 3946);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN)(tr2 == *(EIF_REFERENCE *)(Current))) {
		Result = (nstcall = 0, F328_3291(Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_REFERENCE F343_3304 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F343_3305 (EIF_REFERENCE Current)
{
